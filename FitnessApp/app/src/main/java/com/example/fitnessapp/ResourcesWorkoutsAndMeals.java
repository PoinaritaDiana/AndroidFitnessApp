...
public class ResourcesWorkoutsAndMeals {

    List<String> loseWeightMale = Arrays.asList("https://www.youtube.com/watch?v=OJF1veAhTdE&ab_channel=Men%27sHealth",
    ...
    List<String> loseWeightFemale = Arrays.asList("https://www.youtube.com/watch?v=It-B8xhkZy4&ab_channel=Bodybuilding.com",
    ...
    List<String> gainMuscleMale = Arrays.asList("https://www.youtube.com/watch?v=mcCg_ycMhlA",
            ...
            "https://www.youtube.com/watch?v=mcCg_ycMhlA",
            "https://www.youtube.com/watch?v=DVlIYIwRTLA&ab_channel=Bodybuilding.com",
            "https://www.youtube.com/watch?v=lA7dbOmxs5I&ab_channel=Bodybuilding.com",
            "https://www.youtube.com/watch?v=ubJxrA02MLY&ab_channel=Bodybuilding.comBodybuilding.comVerificat",
            "https://www.youtube.com/watch?v=JXYqd6ugxZw&ab_channel=Bodybuilding.comBodybuilding.comVerificat");

    List<String> gainMuscleFemale = Arrays.asList("https://www.youtube.com/watch?v=Un7s7VwSdV0&ab_channel=Bodybuilding.com",
    ...
    List<String> maintainWeightFemale = Arrays.asList("https://www.youtube.com/watch?v=It-B8xhkZy4&ab_channel=Bodybuilding.com",
            "https://www.youtube.com/watch?v=Un7s7VwSdV0&ab_channel=Bodybuilding.com",
            "https://www.youtube.com/watch?v=Og12jfLMrJw&ab_channel=Bodybuilding.com",
            "https://www.youtube.com/watch?v=AulGwjIv3m8&ab_channel=Bodybuilding.com",
            "https://www.youtube.com/watch?v=e9LD7HoJONg&ab_channel=Bodybuilding.com",
    ...
    List<String> maintainWeightMale = Arrays.asList("https://www.youtube.com/watch?v=OJF1veAhTdE&ab_channel=Men%27sHealth",
            "https://www.youtube.com/watch?v=UcX9OcJDQy4&ab_channel=Men%27sHealth",
            "https://www.youtube.com/watch?v=nOQpD8aDJeI&ab_channel=THENX",
            "https://www.youtube.com/watch?v=xngUfoWLkFw&ab_channel=BullyJuice",
            "https://www.youtube.com/watch?v=AdSLMdQfmqw&ab_channel=Men%27sHealth",
    ...
    public List<String> getLoseWeightFemale() {
        return loseWeightFemale;
    }

    public List<String> getGainMuscleMale() {
        return gainMuscleMale;
    }

    public List<String> getGainMuscleFemale() {
        return gainMuscleFemale;
    }

    public List<String> getMaintainWeightFemale() {
        return maintainWeightFemale;
    }

    public List<String> getMaintainWeightMale() {
        return maintainWeightMale;
    }
}